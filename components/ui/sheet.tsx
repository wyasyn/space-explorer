...
const sheetVariants = cva(
    "fixed z-[1010] gap-4 bg-background pl-12 pt-[3rem] shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
    {
        variants: {
            side: {
